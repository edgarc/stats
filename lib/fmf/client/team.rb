module FMF
  class Client
    module Team
      ...
      #   @example Return information for monarcas morelia
      #     FMF.team 9
      #     FMF.team "9"
      def team(*args)
        team_id = args.first 
        response = get('?Txml=4&ID='+team_id+'&Tpo=1', {}).Elementos.Elemento
      end
      ...
      #     3 - midfielders
      #     4 - forwards
      #   @example Return goalkeepers for monarcas morelia
      #     FMF.players 9, 1
      def players(*args)        
        team_id = args.first 
      ...
      #   @param team_id [Integer, String] Valid fmf team id 
      #   @example Return managers for monarcas morelia
      #     FMF.managers 9
      def managers(*args)
        team_id = args.first 
      ...
      #   @example Return local seasons for monarcas morelia
      #     FMF.seasons 9, 1
      def seasons(*args)
      ...
      #   @example Return fixtures for a given season for monarcas morelia
